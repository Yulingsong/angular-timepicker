...
angular.module('ui.bootstrap.datepicker', ['ui.bootstrap.dateparser', 'ui.bootstrap.position'])
    ...
    .controller('DatepickerController', ['$scope', '$attrs', '$parse', '$interpolate', '$timeout', '$log', 'dateFilter', 'datepickerConfig',
        function($scope, $attrs, $parse, $interpolate, $timeout, $log, dateFilter, datepickerConfig) {
            ...
            angular.forEach(['formatDay', 'formatMonth', 'formatYear', 'formatDayHeader', 'formatDayTitle', 'formatMonthTitle', 'minMode', 'maxMode', 'showWeeks', 'startingDay', 'yearRange'],
                function(key, index) {
            ...
            angular.forEach(['minDate', 'maxDate'],
                function(key) {
                    if ($attrs[key]) {
                        $scope.$parent.$watch($parse($attrs[key]),
                            function(value) {
                    ...
                    angular.forEach(['minDate', 'maxDate', 'datepickerMode'],
                        function(key) {
                            if (attrs[key]) {
                                ...
                                scope.$parent.$watch(getAttribute,
                                    function(value) {
                        ...
                        $modal.open = function(modalOptions) {
                            ...
                            templateAndResolvePromise.then(function resolveSuccess(tplAndVars) {
                                    ...
                                    if (modalOptions.controller) {
                                        ...
                                        angular.forEach(modalOptions.resolve,
                                            function(value, key) {
        ...
        function($scope, $attrs, $parse) {
            ...
            this.init = function(ngModelCtrl_, config) {
                ...
                if ($attrs.itemsPerPage) {
                    $scope.$parent.$watch($parse($attrs.itemsPerPage),
                        function(value) {
        ...
        function($parse, paginationConfig) {
            return {
                ...
                link: function(scope, element, attrs, ctrls) {
                    ...
                    if (attrs.maxSize) {
                        scope.$parent.$watch($parse(attrs.maxSize),
                            function(value) {
...
angular.module('ui.bootstrap.timepicker', [])
    ...
    .controller('TimepickerController', ['$scope', '$attrs', '$parse', '$log', '$locale', 'timepickerConfig',
        function($scope, $attrs, $parse, $log, $locale, timepickerConfig) {
            ...
            if ($attrs.minuteStep) {
                $scope.$parent.$watch($parse($attrs.minuteStep),
                    function(value) {
            ...
            if ($attrs.showMeridian) {
                $scope.$parent.$watch($parse($attrs.showMeridian),
                    function(value) {
